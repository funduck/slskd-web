...
```typescript
import type { SlskdSearchAPISearchRequest } from ''
...
const example = {
  ...
  "search_timeout": null,
  "token": null,
} satisfies SlskdSearchAPISearchRequest
...
const exampleParsed = JSON.parse(exampleJSON) as SlskdSearchAPISearchRequest
